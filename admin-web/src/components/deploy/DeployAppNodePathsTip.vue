<template>
  <div class="deploy-hover-tip">
    <div class="deploy-hover-tip__title">{{ t('deployCenter.appNodePathsTitle') }}</div>
    <div
      v-for="item in deployAppNodePaths"
      :key="item.path"
...
import { deployAppNodePaths } from '@/data/deploy-center'
