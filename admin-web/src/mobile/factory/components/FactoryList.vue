<template>
  <section class="mfc-section">
    <div class="mfc-section__head">
      <img class="mfc-section__icon" :src="schemeAAssets.starBlue" alt="" />
      <h2 class="mfc-section__title">{{ factory.t('mobile.factory.factoryList') }}</h2>
      <span class="mfc-section__count">{{ factory.total.value }}</span>
    </div>
