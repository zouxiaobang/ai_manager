<template>
  <MobilePage>
    ...
    <MobileExpressDetailModal
      v-model="detailOpen"
      :station-id="selectedStationId"
    />

    <MobileExpressCalcModal
      v-model="calcOpen"
...
import MobileExpressDetailModal from '@/mobile/views/express/components/MobileExpressDetailModal.vue'
import MobileExpressCalcModal from '@/mobile/views/express/components/MobileExpressCalcModal.vue'
