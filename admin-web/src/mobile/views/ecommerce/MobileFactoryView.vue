<template>
  <MobilePage>
    <div v-loading="factory.loading.value" class="v2-factory">
      ...
      <MobileFactoryFormSheet />
      <MobileFactoryDeleteConfirm />
    </div>
  </MobilePage>
</template>
...
import MobileFactoryFormSheet from '@/mobile/views/factory/components/MobileFactoryFormSheet.vue'
import MobileFactoryDeleteConfirm from '@/mobile/views/factory/components/MobileFactoryDeleteConfirm.vue'
