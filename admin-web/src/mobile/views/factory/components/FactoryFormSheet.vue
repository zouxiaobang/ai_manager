          ...
          <header class="mfc-form-sheet__header">
            <div class="mfc-form-sheet__header-main">
              <div class="mfc-form-sheet__title-row">
                <img class="mfc-form-sheet__title-icon" :src="schemeAAssets.starBlue" alt="" />
          ...
          <div class="mfc-form-sheet__body">
            <div class="mfc-form-sheet__type-cards">
              <SchemeADoodleFrame
                ...
                :color="typeOpt.color"
                :shadow="false"
                :sketch="factory.form.factoryType === typeOpt.value"
                :seed="typeOpt.seed"
            ...
            <label class="mfc-form-sheet__field mfc-form-sheet__field--full">
              ...
              <SchemeADoodleFrame color="#8b5cf6" :shadow="false" class="mfc-form-sheet__input-frame">
            ...
            <div class="mfc-form-sheet__status">
              ...
              <div class="mfc-form-sheet__status-toggle">
                <SchemeADoodleFrame
                  ...
                  color="#8b5cf6"
                  :shadow="false"
                  :sketch="factory.form.status === 'ENABLED'"
                ...
                <SchemeADoodleFrame
                  ...
                  color="#cbd5e1"
                  :shadow="false"
                  :sketch="factory.form.status === 'DISABLED'"
                  class="mfc-form-sheet__status-btn"
