<template>
  <MobilePage>
    ...
    <MobileCard v-if="pinnedTodos.length">
      <h2 class="mobile-section-title">{{ t('portal.dashboard.pinnedTodos.title') }}</h2>
    ...
    <MobileCard>
      <h2 class="mobile-section-title">{{ t('portal.dashboard.warRoom.systemStatus') }}</h2>
