<template>
  <component
    ...
    :class="[
      `sa-doodle-frame--${shape}`,
      { 'sa-doodle-frame__shadow': selected },
      attrs.class,
    ]"
    :style="frameStyle"
  >
...
import {DOODLE_FRAME_PATHS, DOODLE_FRAME_VIEWBOX, type DoodleFrameShape, resolveDoodleRectPath,} from './doodlePaths'
