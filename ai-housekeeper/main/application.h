...
#define MAIN_EVENT_RESET_LSE            (1 << 13)
#define MAIN_EVENT_TOGGLE_MENU          (1 << 14)
...
public:
    ...
    void sendGlobalEvent(GlobalEvent event);
...
private:
    ...
    // 新增处理--在聆听、说话状态下，都直接到待机状态
    void HandleResetLSEvent();
    // 打开菜单
    void HandleToggleMenuEvent();
