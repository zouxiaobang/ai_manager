...
#define TOUCH_BUTTON_UP       GPIO_NUM_9
#define TOUCH_BUTTON_DOWN     GPIO_NUM_11

#define CAN_TOUCH   true
#define DISPLAY_TOUCH_SCL  GPIO_NUM_1
#define DISPLAY_TOUCH_SDA  GPIO_NUM_2
