> **ai-housekeeper（AI管家）**：本项目由 [xiaozhi-esp32](https://github.com/78/xiaozhi-esp32) v2.2.1 二次开发而来，基于自定义板 \kyle-s3-lcd\ 深度定制。架构与功能说明见 [docs/architecture.md](docs/architecture.md)，改名触点与风险见 [docs/rename-contacts.md](docs/rename-contacts.md)。
